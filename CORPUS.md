...
| **fabius-design** | `fabius-decor` | semantic tokens, the visual-system template (captured before, written at finish), original layout recipes, deterministic scenes, RTL/BiDi and critique procedures | [`skills/fabius-decor/references/design-system.md`](skills/fabius-decor/references/design-system.md) | Fabius procedures |
...
| **fabius-praesidium** | `fabius-praesidium` | defensive hardening guides and audit checklists, the personal-agent trust boundaries and grant lifecycle | [`skills/fabius-praesidium/references/security-playbook.md`](skills/fabius-praesidium/references/security-playbook.md) | Fabius procedures |
